...
release_tag: 2.0-alpha-2017-03-15
layout: release
builds_commit: 0d0cc70bcc3aee4564d237234ccef35f92953c5c
versions_commit: 72cf3fbb88cb540729dec401a0d540566812cd51
packages:
 -
   name: SLOF
   version: 20170303
 ...
 -
   name: kernel
   version: 4.10.0
   release: 6.gitfb71dea.el7.centos
   sources:
   - src: https://github.com/open-power-host-os/linux.git
     branch: hostos-devel
     commit_id: fb71deab42a6d5f6dd631386f0defc954ad7eb19
 -
   name: kimchi
   version: 2.3.0
 ...
 -
   name: qemu
   version: 2.8.0
   release: 6.git27ddb62.el7.centos
   sources:
   - src: https://github.com/open-power-host-os/qemu.git
     branch: hostos-devel
     commit_id: 27ddb62b6526f44c9eff0797ba49b1b14f122f07
 -
   name: servicelog
   version: 1.1.14
