...
- name: lsvpd
  ...
  version: 1.7.8
- name: qemu
  release: 2.gitc334a4e.el7.centos
  sources:
  - branch: hostos-release
...
- name: ppc64-diag
  ...
  version: 2.7.4
release_tag: 2017-10-06
title: OpenPOWER Host OS release
versions_commit: 9d9fbe2f27800a722b32ec0dfb50b1e76b87bd3a
highlights: |
    - Improved test suite.
    - Updated documentation.
    - Bug fixes.
    - Started testing Ubuntu and OpenPOWER Host OS as a guest.
---
