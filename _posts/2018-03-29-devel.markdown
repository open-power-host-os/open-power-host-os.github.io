...
- name: open-power-host-os
  release: 26.dev.el7.centos
  sources: []
  version: '3.5'
- name: kernel
  release: 1.rc7.dev.git58079f0.el7.centos
  sources:
  - branch: hostos-devel
    commit_id: 58079f0e6e987b7f533408a59c4791730f735466
...
- name: ppc64-diag
  ...
  version: 2.7.4
release_tag: 3.5-dev-2018-03-29
title: OpenPOWER Host OS release
versions_commit: 5625f31a54d208fcd1ea7700f1b352630781b99a
