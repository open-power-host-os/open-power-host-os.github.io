...
packages:
 ...
 -
   ...
   - src: https://github.com/open-power-host-os/ginger.git
     branch: hostos-devel
     commit_id: 50b2b552c0ee4cbca6004572830fac38e9954ba3
 -
   name: ginger-base
   version: 2.2.1
 ...
 -
   ...
   - src: https://github.com/open-power-host-os/kimchi.git
     branch: hostos-devel
     commit_id: 4ea4cef057617b43381e7e3b913b4a34104cac40
 -
   name: kubernetes
   version: 1.2.0
 ...
 -
   ...
   - src: https://github.com/open-power-host-os/wok.git
     branch: hostos-devel
     commit_id: 0489d72cbf7f3f33da304ae83a7bacedcc1bb7d5
